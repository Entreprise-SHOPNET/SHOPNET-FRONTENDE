...
export default function PaiementPremium() {
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      if (selectedMethod === "mobile") {
        ...
        router.push("/(tabs)/Auth/Boutique/Premium/PaiementBancaire");
        setLoading(false);
        return;
      }
  ...
  const processMobileMoneyPayment = async (paymentData: any) => {
    return new Promise((resolve, reject) => {
      setTimeout(() => {
        ...
        console.log("Paiement Mobile Money envoyé:", paymentData);
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        >
          ...
          <Text style={styles.headerTitle}>Paiement Premium</Text>
        ...
        >
          ...
          <PaymentMethodButton
            method="mobile"
            title="Mobile Money"
            icon={<FontAwesome5 name="mobile-alt" size={20} color={PREMIUM_GOLD} />}
          ...
          <PaymentMethodButton
            ...
            icon={<FontAwesome5 name="credit-card" size={20} color={PREMIUM_GOLD} />}
          ...
          {selectedMethod === "mobile" ? (
            ...
            <View style={styles.form}>
                  ...
                  {[
                    ...
                    >
                      <MaterialIcons 
                        ...
                        size={16} 
                        color={mobileOperator === operator.id ? "#fff" : PREMIUM_GOLD} 
                      />
                      <Text style={[
              ...
              <View style={styles.inputGroup}>
                ...
                <View style={styles.amountInput}>
                  ...
                  <Text style={styles.amountValue}>9.99</Text>
                </View>
                <Text style={styles.helperText}>
              ...
              <View style={styles.infoBox}>
                <MaterialIcons name="info" size={16} color={PREMIUM_GOLD} />
            ...
            <View style={styles.form}>
              <View style={styles.cardRedirectInfo}>
                <MaterialIcons name="credit-card" size={48} color={PREMIUM_GOLD} />
            ...
            {loading ? (
              ...
              <>
                ...
                <Text style={styles.paymentButtonText}>
                  {selectedMethod === "mobile" ? "Payer $9.99 - Activer Premium" : "Continuer vers le Paiement"}
                </Text>
              </>
            )}
          </TouchableOpacity>
