...
// ============================================
const API_URL =
  "https://shopnet-backend.onrender.com/api/products/ai/auto-moto";
    ...
    <TouchableOpacity style={styles.card} onPress={onPress} activeOpacity={0.7}>
      ...
      <View style={styles.cardContent}>
        ...
        <View style={styles.sellerRow}>
          <Image
            source={{
              uri: item.seller.avatar || "https://via.placeholder.com/16",
            }}
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>🚗 Auto/Moto IA</Text>
