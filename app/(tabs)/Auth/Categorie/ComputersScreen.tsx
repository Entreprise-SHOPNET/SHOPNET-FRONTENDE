...
// CONFIGURATION
// ============================================
const API_URL = "https://shopnet-backend.onrender.com/api/products/ai/computers";
      ...
      <View style={[styles.imageContainer, { backgroundColor: colors.imageBg }]}>
        ...
        {showCategoryBadge && (
          <View style={[styles.categoryBadge, { backgroundColor: colors.accent }]}>
            <Text style={styles.categoryBadgeText}>💻 Ordinateur</Text>
          </View>
        )}
        {discount > 0 && (
...
// ============================================
// ÉCRAN PRINCIPAL ORDINATEURS AI
// ============================================
export default function ComputersAIScreen() {
  ...
  const fetchProducts = async (pageNum: number, shouldCache = true) => {
    try {
      const cacheKey = `computers_ai_${pageNum}`;
      if (shouldCache) {
      ...
      console.log("🔍 Fetching computers AI:", url);
  ...
  const onRefresh = async () => {
    setRefreshing(true);
    try {
      await AsyncStorage.removeItem("computers_ai_1");
  ...
  if (loading && rows.length === 0) {
    return (
      <SafeAreaView style={[styles.loadingContainer, { backgroundColor: COLORS.loadingBg }]}>
        ...
        <Text style={[styles.loadingText, { color: COLORS.textSecondary }]}>Chargement des ordinateurs...</Text>
      </SafeAreaView>
    );
  }
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: COLORS.background }]}>
      ...
      <View style={[styles.header, { backgroundColor: COLORS.headerBg, borderBottomColor: COLORS.headerBorder }]}>
        ...
        <Text style={[styles.headerTitle, { color: COLORS.text }]}>💻 Ordinateurs IA</Text>
