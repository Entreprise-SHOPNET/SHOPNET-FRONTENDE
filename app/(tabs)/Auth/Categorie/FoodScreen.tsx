...
// ============================================
const API_URL = "https://shopnet-backend.onrender.com/api/products/ai/food";
...
export default function FoodAIScreen() {
  ...
  const fetchProducts = async (pageNum: number, shouldCache = true) => {
    try {
      const cacheKey = `food_ai_${pageNum}`;
      if (shouldCache) {
      ...
      console.log("🔍 Fetching food AI:", url);
  ...
  const onRefresh = async () => {
    setRefreshing(true);
    try {
      await AsyncStorage.removeItem("food_ai_1");
    ...
    return (
      <View style={styles.emptyContainer}>
        ...
        <Text style={styles.emptyText}>
          {error || "Aucun produit alimentaire trouvé"}
        </Text>
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>🍔 Food IA</Text>
