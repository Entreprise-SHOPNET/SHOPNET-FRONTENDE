      ...
      <View style={[styles.imageContainer, { backgroundColor: colors.imageBg }]}>
        ...
        {showDistance && item.distance && (
          <View style={[styles.distanceBadge, { backgroundColor: colors.distanceBg }]}>
            <Ionicons name="location-outline" size={10} color={colors.distanceText} />
            <Text style={[styles.distanceBadgeText, { color: colors.distanceText }]}>{formatDistance(item.distance)}</Text>
          </View>
        )}
      </View>
...
export default function NearbyScreen() {
  ...
  const renderEmpty = () => {
    ...
    if (error) {
      return (
        <View style={styles.emptyContainer}>
          ...
          <Text style={[styles.emptyText, { color: COLORS.emptyIcon }]}>{error}</Text>
    ...
    return (
      <View style={styles.emptyContainer}>
        <Ionicons name="location-outline" size={60} color={COLORS.emptyIcon} />
        ...
        {locationStatus === "denied" && (
          <TouchableOpacity style={[styles.retryButton, { backgroundColor: COLORS.retryBg }]} onPress={onRefresh}>
            <Text style={[styles.retryButtonText, { color: COLORS.retryText }]}>Actualiser</Text>
          </TouchableOpacity>
        )}
      </View>
    );
...
const styles = StyleSheet.create({
  ...
  distanceBadgeText: { fontSize: 8, fontWeight: "600", marginLeft: 2 },
