...
// Vérifie si le produit a moins de 6h (pour badge "flash")
      ...
      <View style={styles.imageContainer}>
        ...
        {isUltraRecent && (
          <View style={styles.clockBadge}>
            ...
            <Text style={styles.clockText}>Flash</Text>
          </View>
        )}
      </View>
  ...
  const renderEmpty = () => {
    ...
    return (
      <View style={styles.emptyContainer}>
        ...
        <Text style={styles.emptyText}>{error || "Aucun produit récent trouvé"}</Text>
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>🕐 Nouveautés -24h</Text>
