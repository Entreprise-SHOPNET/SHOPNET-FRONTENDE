  ...
  return (
    <TouchableOpacity style={[styles.card, { backgroundColor: colors.card, borderColor: colors.border }]} onPress={onPress} activeOpacity={0.7}>
      <View style={[styles.imageContainer, { backgroundColor: colors.imageBg }]}>
        ...
        {isTopSeller && (
          <View style={[styles.salesBadge, { backgroundColor: colors.salesBadge }]}>
            <Ionicons name="trophy-outline" size={10} color={colors.white} />
    ...
    return (
      <View style={styles.emptyContainer}>
        ...
        <Text style={[styles.emptyText, { color: COLORS.emptyIcon }]}>
          {error || "Aucun produit top vente trouvé"}
        </Text>
  ...
  if (loading && rows.length === 0) {
    return (
      <SafeAreaView style={[styles.loadingContainer, { backgroundColor: COLORS.loadingBg }]}>
        ...
        <Text style={[styles.loadingText, { color: COLORS.textSecondary }]}>Chargement des meilleures ventes...</Text>
      </SafeAreaView>
    );
  }
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: COLORS.background }]}>
      ...
      <View style={[styles.header, { backgroundColor: COLORS.headerBg, borderBottomColor: COLORS.headerBorder }]}>
        ...
        <Text style={[styles.headerTitle, { color: COLORS.text }]}>🏆 Top Ventes</Text>
...
const styles = StyleSheet.create({
  ...
  salesBadgeText: { color: "#FFFFFF", fontSize: 8, fontWeight: "600", marginLeft: 2 },
